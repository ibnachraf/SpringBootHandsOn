error id: file://<WORKSPACE>/src/main/java/ibn/achraf/demo/streams/TopologyConfig.java
file://<WORKSPACE>/src/main/java/ibn/achraf/demo/streams/TopologyConfig.java
### com.thoughtworks.qdox.parser.ParseException: syntax error @[11,5]

error in qdox parser
file content:
```java
offset: 311
uri: file://<WORKSPACE>/src/main/java/ibn/achraf/demo/streams/TopologyConfig.java
text:
```scala
...
QDox parse error in file://<WORKSPACE>/src/main/java/ibn/achraf/demo/streams/TopologyConfig.java